                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method"  type="radio" value="cod" checked=""> <label> Thanh toán khi nhận hàng</label><br>
                                                <input name="payment_method"  type="radio" value="transfer"> <label> Chuyển khoản</label> 
                                            </form-group>
