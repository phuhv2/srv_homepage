    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{route('users.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
               data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm người dùng</a>
        </div>
        <div class="card-body">
                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td style="text-align: center">
                                @if($user->photo)
                                    <img src="{{$user->photo}}" class="img-fluid rounded-circle" style="max-width:30px"
                                         alt="{{$user->photo}}">
                                @else
                                    <img src="{{asset('backend/img/avatar.png')}}" class="img-fluid rounded-circle"
                                         style="max-width:30px" alt="avatar.png">
                                @endif
                            </td>
