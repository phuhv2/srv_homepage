    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
               data-placement="bottom" title="Thêm danh mục bài viết"><i class="fas fa-plus"></i> Thêm danh mục bài viết</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                @if(count($postCategories)>0)
                    ...
                    <span style="float: right;">{{$postCategories->links('pagination::bootstrap-4')}}</span>
                @else
