    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
               data-placement="bottom" title="Thêm thẻ bài viết"><i class="fas fa-plus"></i> Thêm thẻ bài viết</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                @if(count($postTags)>0)
                    ...
                    <span style="float: right;">{{$postTags->links('pagination::bootstrap-4')}}</span>
                @else
