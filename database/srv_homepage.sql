...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 25, 2025 lúc 06:33 AM
...
(13, 'Tổ chức buổi lễ chào đón thực tập sinh Kỹ năng đến từ SRV tại nhà máy HB Kakogawa', 'to-chuc-buoi-le-chao-don-thuc-tap-sinh-ky-nang-den-tu-srv-tai-nha-may-hb-kakogawa', 'Vào ngày 14 tháng 3, Nhà máy Kakogawa đã tổ chức buổi lễ chào đón các thực tập sinh kỹ năng đến từ SRV', '<p>Buổi lễ diễn ra trong không khí ấm cúng và thân thiện với lời chào mừng từ bác Tsuzaki và các phòng ban tiếp nhận. Các hoạt động như \"ice break\" (phá băng làm quen) và phần giới thiệu người khác thay vì bản thân (giới thiệu hộ) đã góp phần tạo nên nhiều tiếng cười và sự gắn kết, làm cho buổi lễ trở nên tràn đầy ý nghĩa và tiếng cười.</p><p>Lời chào mừng từ bác Tsuzaki (Bất ngờ với phần mở đầu bằng tiếng Viêt của bác !)</p><p><img src=\"http://localhost:8080/srv_homepage/storage/photos/1/Picture2.jpg\" style=\"width: 100%;\"></p><p>Trò bắt tên (name catch) giúp ghi nhớ tên gọi thông qua trò chơi có sử dụng vật truyền tay là&nbsp; cao su do chính bộ phận 2 FR sản xuất</p><p><img src=\"http://localhost:8080/srv_homepage/storage/photos/1/Picture3.png\" style=\"width: 100%;\"></p><p>Trò chơi truyền tin&nbsp; Ngày đầu tiên : Thử thách nói Tiếng Nhật</p><p><img src=\"http://localhost:8080/srv_homepage/storage/photos/1/Picture4.jpg\" style=\"width: 100%;\"></p><p>Ngày thứ hai:&nbsp; Tiếng Việt!</p><p>&nbsp;<img src=\"http://localhost:8080/srv_homepage/storage/photos/1/Picture6.jpg\" style=\"width: 25%;\">&nbsp;<img src=\"http://localhost:8080/srv_homepage/storage/photos/1/Picture7.png\" style=\"width: 25%;\"></p><p>Giới thiệu người khác và luyện tập sử dụng máy phiên dịch Pocketalk‼</p><p><img src=\"http://localhost:8080/srv_homepage/storage/photos/1/Picture8.png\" style=\"width: 25%;\">&nbsp;<img src=\"http://localhost:8080/srv_homepage/storage/photos/1/Picture9.png\" style=\"width: 25%;\"><br></p><p>Ngoài ra, hai nhân viên chuyển công tác nội bộ của tập đoàn chị Dung và chị&nbsp; Huế cũng đã có phần giới thiếu bản thân trong buổi lễ.</p><p><i>Chị Kawabe Maki –(bộ phận Kế hoạch HB )kiêm&nbsp; bộ phận Nhân sự HB Kakogawa</i></p><p><img src=\"http://localhost:8080/srv_homepage/storage/photos/1/Picture10.png\" style=\"width: 25%;\"></p><h3 style=\"margin: 15px 0px; font-weight: 700; line-height: 32px; font-size: 14px; font-family: &quot;Open Sans&quot;, Arial, sans-serif; color: rgb(28, 27, 27); padding: 0px;\"><p class=\"markup-text mb-35\" style=\"margin-right: 0px; margin-bottom: 35px; margin-left: 0px; padding: 40px 40px 50px 30px; color: rgb(102, 102, 102); font-weight: 400; font-style: italic; clear: both; border-left: 10px solid rgb(35, 134, 203); font-family: Roboto, sans-serif; font-size: 16px; box-shadow: rgb(238, 238, 238) 0px 0px 150px !important;\"><i style=\"color: rgb(0, 0, 0); font-family: Nunito, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;, &quot;Noto Color Emoji&quot;;\">Khi quan sát sự tương tác giữu các thành viên của nhà máy Kakogawa và các bạn đến từ SRV , tôi cảm nhận được rằng trong quá trình tiếp nhận thực tập sinh, sự thấu hiểu và tương trợ hỗ trợ lẫn nhau là điều vô cùng quan trọng.&nbsp; Tôi mong rằng không chỉ dừng lại ở việc nâng cao kỹ năng&nbsp; cho các bạn thực tập sinh mà dựa vào việc học hỏi lẫn nhau và nhận ra những giá trị hai bên mà có thể cùng nhau phát triển .</i></p></h3>', NULL, 'http://localhost:8080/srv_homepage/storage/photos/1/Picture2.jpg', 'factory', 13, NULL, 1, 'active', '2025-06-09 18:52:49', '2025-06-09 19:27:19');
...
(13, 'Nhà Máy', 'nha-may', 'active', '2025-06-09 18:42:40', '2025-06-09 18:42:40');
